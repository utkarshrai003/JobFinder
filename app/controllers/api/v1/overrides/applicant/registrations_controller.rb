class Api::V1::Overrides::Applicant::RegistrationsController < DeviseTokenAuth::RegistrationsController
...
def create
  ...
  def sign_up_params
    params.permit(devise_parameter_sanitizer.for(:sign_up).push(:name , :current_location , :experience))
  end
